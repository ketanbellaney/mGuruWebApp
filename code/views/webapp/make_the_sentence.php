...
<section id="dailyquest" class="mg-activity">
    <div class="mg-activity-1">
        ...
        <div class="container">
            ...
            <?php
                $obj = $question_set;
                $answer = str_replace(" ","",$obj->question->text);
                $answer1 = $obj->question->text;

                $options = explode("#",$obj->wrong_options);
                shuffle($options);
            ?>
            <div class="row mg-daily-activity-wrapper clearfix">
                <div class="col-md-12 text-center">

                    <div class="mg-arrange-phrase">
                        ...
                        <ul class="mg-options-wrapper list-unstyled list-inline">
                            <?php foreach($options as $val) { ?>
                                <li class="mg-void">
                                    <span class="mg-text-black"><?php echo $val; ?></span>
    ...
    <input type='hidden' id='act_answer_readable' value="<?php echo $answer1; ?>" />
