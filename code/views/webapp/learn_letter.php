            ...
            <div class="row mg-daily-activity-wrapper clearfix">
                <div class="col-md-8 col-md-offset-2 text-center">
                    ...
                    <div class="mg-say">
                        ...
                        ?>
                            <div class=" text-uppercase"><?php echo $gra; ?></div>
                        </div>
                        <ul class="mg-activity-sound-wrapper list-unstyled list-inline">
                            <li class="mg-void">
                                <img src="<?php echo base_url("contentfiles/grapheme/" . $grapheme['image'] ); ?>" alt="mGuru Listen" class="mg-say-img mg-listen" data-step=1 />
