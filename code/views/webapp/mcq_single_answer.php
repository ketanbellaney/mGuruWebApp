            ...
            <div class="row mg-daily-activity-wrapper clearfix">
                <div class="col-md-12 text-center">
                    ...
                    <div class="mg-missing-word ">
                        <div class="mg-query-text text-center" style='font-size: 30px !important; ' >
                            <?php
                        ...
                        <ul class="mg-options-wrapper list-unstyled list-inline" >
                            <?php foreach( $options as $val ) { ?>
                                <li class="mg-void" data-value="<?php echo $val->text; ?>" ><span class="mg-text-black"><?php echo $val->text; ?></span></li>
                            <?php } ?>
                        </ul>
                    </div>
