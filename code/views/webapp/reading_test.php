...
<section id="dailyquest" class="mg-activity">
    <div class="mg-activity-1">
        ...
        <div class="container compress-85">
            <div class="row clearfix">
                <div class="col-md-12 text-center">
                    <h1 class="mg-h1-header mg-text-primary mg-shadow-text" style='font-size: 40px !important;line-height: 1.4 !important;'>
                        <?php echo @$_translation->array[$_lang_map]->item[133]; ?>
            ...
            <?php
                ...
                $questionsss = json_decode($question['question']);
                $options = $questionsss->options;
                shuffle($options);
             ?>
                    ...
                    <div class="mg-letter-sound ">
                        ...
                        <ul class="mg-options-wrapper list-unstyled list-inline">
                            <?php foreach($options as $val) { ?>
                                <li class="mg-void" data-value="<?php echo $val->text; ?>" >
                                    <span class="mg-text-warning text-uppercase"><?php echo $val->text; ?></span>
                                </li>
                            <?php
                                if($val->ans == 1) {
                                    $answer = $val->text;
    ...
    <input type='hidden' id='audio_tts_ans' value='<?php echo $answer; ?>' />
