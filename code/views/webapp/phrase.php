...
?>
        ...
        <div class="container compress-75">
            <div class="row clearfix">
                <div class="col-md-12 text-center">
                    <h1 class="mg-h1-header mg-text-primary mg-shadow-text" style='font-size: 40px !important; line-height: 1.2 !important;'>
                        <?php echo @$_translation->array[$_lang_map]->item[110]; ?>
            ...
            <div class="row mg-daily-activity-wrapper clearfix">
                <div class="col-md-12 text-center">
                    ...
                    <div class="mg-say">
                        <div class="mg-image-text-hint mg-drop-wrapper">
                            <div class=" " style='font-size: 20px !important;'><?php echo $question['sentences'][0]['sentence']; ?></div>
                        </div>
    ...
    <input type='hidden' id='phrase_sentence' value="<?php echo $question['sentences'][0]['sentence']; ?>" />
