        ...
        <div class="container-fluid compress-80">
            ...
            <div class="row mg-daily-activity-wrapper clearfix">
                <div class="col-md-8 col-md-offset-2 text-center">
                    ...
                    <a href="<?php echo site_url("stories/books"); ?>" class="mg-btn-danger mg-btn-rounded mg-next text-center text-uppercase next-level"><?php echo @$_translation->array[$_lang_map]->item[210]; ?></a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    var orderNumber = 0;
    var activityCount = <?php echo $question_count; ?>;
    var activityId = <?php echo $story_id; ?>;
    var activityLinkage = new Array();
    var activityLinkage1 = new Array();
    ...
    function callnextquestion() {
        audioPlayercorrect = document.getElementById("defaultcorrectaudio");
        audioPlayerwrong = document.getElementById("defaultwrongaudio");
        audioPlayercorrect.load;
        audioPlayerwrong.load;
    ...
    function callnextquestionpull() {
        ...
        if(orderNumber >= activityCount)  {
            ...
            $.post("<?php echo site_url("webapp/savestoryquestion"); ?>",{
              score: score, points:points, activity_id: activityId, act_link: activityLinkage,question:activityLinkage1,  scorearray:scorearray,pointsarray:pointsarray,answersarray:answersarray,canswersarray:canswersarray  },function( data ) {
                $(".main-activity-div").addClass('hide');
            ...
            $.post("<?php echo site_url("webapp/getstoryquestion"); ?>",{num: orderNumber,activityCount:activityCount, activity_id: activityId, act_link: 1  },function( data ) {
                mActivityDetails.push(data);
                $(".main-activity-div").html(data);
                activityLinkage.push($("#question_id_used").val());
                activityLinkage1.push($("#question_used").val());
