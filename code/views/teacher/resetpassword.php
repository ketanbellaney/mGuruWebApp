<div class="container main-container" >
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 align="center" style="font-family: din,Calibri,Cantarell,sans-serif;"><b>Reset Password</b></h1>
            <?php
                if($meta_type == 1 ) {
            ...
            ?>
                ...
                <div class="col-md-4 col-lg-4 col-sm-8 col-xs-12 text-center">
                    <form class="form-horizontal form-group" action='<?php echo site_url("teacher/resetpassword/$meta_type/$mcode"); ?>' data-toggle="validator" method="POST" onsubmit='return validateregistration();' >
                        <fieldset>
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <br /><br />
                                    <a href="<?php echo site_url("teacher/forgotpassword"); ?>" >Resend <?php echo $mmm; ?>?</a>
                                </div>
                            </div>
                        </fieldset>
                    </form>
