<div class="container main-container" style='min-height:400px;'>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h4 class='alert alert-success'>Your download will start in few seconds! Thank you! <a href='<?php echo site_url("worksheet/downloadpdf1/" . @$ws->id); ?>' >click here for direct download</a></h4>
...
mixpanel.track("Referral Page");
    ...
    function onloaddothis() {
        window.location.href='<?php echo site_url("worksheet/downloadpdf1/" . $ws->id); ?>';
    }
