...
<img src='<?php echo base_url("images/worksheetsplash1.jpg"); ?>' class='img-responsive' style='margin: 0 auto;width: 100%;'  />
    ...
    ?>
        ...
        <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 text-center" style='margin-bottom: 30px;'>
            <a type="button" class="btn btn-info btn-lg col-md-12 col-lg-12 col-sm-12 col-xs-12" href="<?php echo site_url("worksheet/listview"); ?>" >My worksheet(s)</a><br />
        </div>
        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-center" style='margin-bottom: 30px;'>
            <a type="button" class="btn btn-info btn-lg col-md-12 col-lg-12 col-sm-12 col-xs-12" href="<?php echo site_url("worksheet/create"); ?>" >Create worksheet</a><br />
        </div>
        <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 text-center" style='margin-bottom: 30px;'>
            <a type="button" class="btn btn-info btn-lg col-md-12 col-lg-12 col-sm-12 col-xs-12" href="<?php echo site_url("worksheet/refer"); ?>">Refer & Earn</a><br />
        </div>
        <div class="col-md-1 col-lg-1 hidden-sm hidden-xs">
          &nbsp;
        </div>
