<div class="container main-container" style='min-height:400px;'>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1 align="center" style='font-family: din,Calibri,Cantarell,sans-serif; margin-bottom: 5px;'><b>Love using mGuru Math Worksheet?<br />Tell your colleagues and friends. And earn more worksheets credit</b></h1>
            <br />
            <img src='<?php echo base_url("images/shareimage2.png"); ?>' class='img-responsive' style='margin: 0 auto;'  />
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <br />
            <h3 align="center" style='color:#595959; font-family: din,Calibri,Cantarell,sans-serif; font-size: 20px; margin-top: 5px;' >If you love mGuru Math Worksheet, they will too!<br />So spread the word, and you can earn 5 worksheets credit for each one who uses mGuru Math Worksheet - no limit!</h3>
            <br />
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                echo urlencode(site_url("worksheet/signup?refcode=".$user->user_referral_code->referral_code));
            ...
            <span id='eleme' style='display:none;'><?php echo site_url("worksheet/signup?refcode=".$user->user_referral_code->referral_code); ?></span>
        </div>
    </div>
...
mixpanel.track("Referral Page");
    ...
    function sendemails() {
        if(checkemail("#emails")) {
            ...
            $.post( "<?php echo site_url("worksheet/sendemail"); ?>", { emails: $("#emails").val().trim() } , function (data) {
    ...
    function copytoclip () {
        ...
        mixpanel.track("Referral Link Copied", {
          "url": "<?php echo site_url("worksheet/signup?refcode=".$user->user_referral_code->referral_code); ?>"
        });
    }
