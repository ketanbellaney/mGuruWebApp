    ...
    <div class="row">
        <div class="col-lg-12"> <!-- Registration Form -->
            <h2>Edit Activity</h2>
                    ...
                    <form class='form-horizontal' role="form" action="<?php echo site_url('englishcontent/editactivity/' . $activity_id);?>" method="post" name="" enctype="multipart/form-data" onsubmit="return validateregistration();">
